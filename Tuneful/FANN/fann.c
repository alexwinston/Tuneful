															 ...
															 const unsigned int *layers)
{
	...
	ann->num_output = (ann->last_layer - 1)->last_neuron - (ann->last_layer - 1)->first_neuron - 1.0;
	ann->num_input = ann->first_layer->last_neuron - ann->first_layer->first_neuron - 1.0;
	...
	{
		num_neurons_out = layer_it->last_neuron - layer_it->first_neuron - 1.0;
	...
	else
	{
		...
		for(layer_it = ann->first_layer + 1; layer_it != ann->last_layer; layer_it++)
		{
			...
			num_neurons_out = layer_it->last_neuron - layer_it->first_neuron - 1.0;
			num_neurons_in = (layer_it - 1)->last_neuron - (layer_it - 1)->first_neuron - 1.0;
